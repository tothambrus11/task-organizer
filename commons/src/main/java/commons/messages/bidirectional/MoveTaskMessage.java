...
public class MoveTaskMessage extends Message {
    private UUID taskId;
    ...
    public MoveTaskMessage() {
    }

    public MoveTaskMessage(UUID taskId, UUID sourceListId, UUID targetListId, BigFraction targetPosition) {
        this.taskId = taskId;
